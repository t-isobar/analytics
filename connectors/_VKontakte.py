...
class VKApp:
    ...
    def get_ads(self, campaign_ids):
        campaign_ids = my_slice(campaign_ids, 100, slice_list=[])
        ads_list = []
    ...
    def get_demographics(self, demographics_list_ids, date_from, date_to, limit=2000):
        ...
        demographics_list = my_slice(demographics_list_ids, limit, slice_list=[])
    ...
    def get_day_stats(self, ids_type, list_of_ids, date_from, date_to, limit=2000):
        day_stat_list = []
        ids_list = my_slice(list_of_ids, limit, slice_list=[])
